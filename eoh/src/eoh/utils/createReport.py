...
class ReportCreator:
    ...
    def create_convergence(self):
        ...
        for i in range(n_start, n_start + self.ec_n_pop):
            ...
            with open(
                ...
                + "ael_results/pops/population_generation_"
                + str(i)
                + ".json"
            ) as file:
                data = json.load(file)
        ...
        plt.plot(
            generations, mean_objective, label="Mean", color="orange", linewidth=3.0
        )
        ...
        plt.scatter(
            [], [], color="tab:blue", alpha=0.6, label="Algorithms", s=200
        )  # Empty scatter plot for legend
        ...
        plt.tight_layout()
        plt.savefig(
            self.exp_output_path + "ael_results/ael_convergence.png"
    ...
    def generate_doc_report(self):
        ...
        doc.add_picture(
            self.exp_output_path + "ael_results/ael_convergence.png", width=Inches(4)
        )
